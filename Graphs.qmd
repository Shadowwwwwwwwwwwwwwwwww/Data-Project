...
```{r}
# Δ VR Anxiety vs. Choice & Environment separated by age ranges
...
# Δ VR Anxiety vs. Choice & Environment separated **NO AGE RANGES**
...
ggplot(data, aes(x = choice, y = vranxiety, color = choice)) +
    labs(title = "Change in Anxiety Level vs. Choice Given",
         x = "Choice Given", 
         y = "Δ VR Anxiety", 
         color = "Choice Given") +
    geom_boxplot() +
...
ggplot(data, aes(x = env, y = vranxiety, fill = env)) +
    labs(title = "Change in Anxiety Level vs. VR Environment",
         x = "VR Environment", 
         y = "Δ VR Anxiety", 
         fill = "VR Environment") +
    geom_boxplot() +
...
ggplot(vranxiety_model, aes(x = .fitted, y = .resid)) +
    ...
    labs(title = "AVRA vs. BVRA Residual Plot",
         x = "Predicted Values",
         y = "Error")
```

```{r}
# Δ State Anxiety Level vs. Choice & Environment separated by age ranges
...
# Δ State Anxiety Level vs. Choice & Environment **NO AGE RANGES**
...
ggplot(data, aes(x = choice, y = stai, color = choice)) +
    labs(title = "Δ State Anxiety Level vs. Choice Given",
         x = "Choice Given",
         y = "Δ STAI Level",
         color = "Choice Given") +
    geom_boxplot() +
...
ggplot(data, aes(x = env, y = stai, fill = env)) +
    labs(title = "Δ State Anxiety Level vs. VR Environment",
         x = "VR Environment",
         y = "Δ STAI Level",
         fill = "VR Environment") +
    geom_boxplot() +
