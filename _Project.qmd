...
#maybe more clear judgement/summary

## Initial Data Analysis

**Overview**

The data was sourced through an experimental survey examining 337 participants for the VR nocebo affect. Our investigation has a unique focus on age groups within the experiments, and how a VR environment may cause a impact on the fluctuation of the participants reported anxiety levels. With these variables we had to reclassify age from a quantitative continuous variable into a qualitative nominal to utilise groups for which the anxiety changed, while the rest remained. These being the VR environment as a qualitative nominal, and the anxiety level's quantitative discrete variable, and choice as a qualitative nominal.
=======
...
#maybe mention how mood will be accounted for
